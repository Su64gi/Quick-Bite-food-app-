...
app.use(cors({
  origin: ['https://quick-bite-food-website.onrender.com/'
    
  ], // Replace with your hosted frontend URL
  methods: ['GET', 'POST'],
}));
...
// Start the server
app.listen(PORT, () => {
    console.log(`Server running on https://quick-bite-food-website.onrender.com/`);
});
